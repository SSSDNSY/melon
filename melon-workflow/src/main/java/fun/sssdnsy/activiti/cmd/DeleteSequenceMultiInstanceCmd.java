...
public class DeleteSequenceMultiInstanceCmd implements Command<Void> {
    ...
    public Void execute(CommandContext commandContext) {
        ...
        Integer nrOfInstances = (Integer) entity.getVariable(ActConstant.NUMBER_OF_INSTANCES);
        entity.setVariable(ActConstant.NUMBER_OF_INSTANCES, nrOfInstances + assignees.size());
        // 设置流程变量
        ...
        variables.put(ActConstant.NUMBER_OF_INSTANCES, userIdList.size());
        variables.put(assigneeList, userIdList);
        variables.put(ActConstant.LOOP_COUNTER, loopCounterIndex);
