...
import fun.sssdnsy.mapper.ProcessDefinitionMapper;
...
public class ProcessDefinitionServiceImpl extends WorkflowService implements IProcessDefinitionService {
     ...
     * @param: definitionBo
     * @return: com.ruoyi.common.core.page.TableDataInfo<com.ruoyi.workflow.ProcessDefinitionVo>
     * @author: gssong
     * @Date: 2021/10/7
     */
    @Override
    public TableDataInfo getByPage(DefinitionBo definitionBo) {
        ...
        return new TableDataInfo(processDefinitionVoList, (int) total);
    }

    /**
     * @Description: 查询历史流程定义列表
     * @param: definitionBo
     * @return: java.util.List<com.ruoyi.workflow.ProcessDefinitionVo>
     * @author: gssong
     * @Date: 2021/10/7
     */
    @Override
    ...
    public AjaxResult deleteDeployment(String deploymentId, String definitionId) {
        try {
            ...
            if (CollectionUtil.isNotEmpty(taskInstanceList)) {
                return AjaxResult.error("当前流程定义已被使用不可删除！");
            }
    ...
    @Override
    @Transactional(rollbackFor = Exception.class)
    public AjaxResult deployByFile(MultipartFile file) {
        try {
            // 文件名+后缀名
